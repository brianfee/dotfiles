...
local battery_bar = require("battery_bar")
...
mytextclock = wibox.widget.textclock("%A, %B %d  ·  %R %Z")
mytextclock.align = "center"
mytextclock.valign = "center"
mytextclock.font = "noto sans bold 9"
...
local batt_icon = wibox.widget.textbox(" ")
batt_icon.font = "fontawesome 9"

local battery_bar = require("battery_bar")
battery_bar.forced_width = 215
...
vol_icon.font = "fontawesome 9"

local volume_bar = require("volume_bar")
volume_bar.forced_width = 215
...
globalkeys = gears.table.join(
	...
	awful.key({ superkey, shiftkey }, "Escape",
				awesome.quit,
			  { group = "awesome", description = "quit awesome wm" }),
	...
	awful.key({ superkey, shiftkey }, "Return", 
				function () awful.spawn(private_browser .. " https://check.torproject.org") end,
			  { group = "launcher", description = "open a private firefox window"}),

	awful.key({ superkey }, "space",
				function () awful.spawn("rofi -show run") end,
			  { group = "launcher", description = "rofi launcher" }),

	awful.key({ altkey }, "Tab",
				function () awful.spawn("rofi -show window") end,
			  { group = "launcher", description = "rofi window menu" }),


	-- Layout keybindings
	awful.key({ superkey }, "Tab",
				function () awful.layout.inc( 1 ) end,
			  { group = "layout", description = "Next layout" }),

	awful.key({ superkey, shiftkey }, "Tab",
				function () awful.layout.inc( -1 ) end,
			  { group = "layout", description = "Previous layout" }),
...
--globalkeys = gears.table.join(keybindings.globalkeys)
--clientkeys = gears.table.join(keybindings.clientkeys)
